...
export default function ShadowScreen() {
  ...
  // Live shadow feed is now the primary view; governance is optional.
    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.content, { paddingTop: insets.top, opacity: fadeAnim }]}>
        ...
        >
            ...
            <>
              {loading ? (
                ...
                <View style={styles.centerContainer}>
                  ...
                  <Text style={styles.emptyText}>No shadow strategies generated yet.</Text>
          ...
          {isGovernanceOnline && !loading && !error && strategies.length > 0 ? (
